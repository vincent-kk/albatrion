...
if (process.argv[1]?.endsWith('selfcheck-v4d.mjs')) {
  // round 7: `node selfcheck-v4d.mjs old` runs every check with OLD_SWITCHES (= loop-v4c behaviour).
