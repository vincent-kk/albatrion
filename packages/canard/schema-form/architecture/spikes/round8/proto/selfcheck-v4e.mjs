...
if (process.argv[1]?.endsWith('selfcheck-v4e.mjs')) {
  // round 7: `node selfcheck-v4e.mjs old` runs every check with OLD_SWITCHES (= loop-v4c behaviour).
