...
| [0014](./adr/0014-error-policy.md) | 오류는 삼키지 않는다 — 오류·경고·검증 결과의 세 층, 진입 사슬의 끝에서 한 번 throw, `onError` 관찰자, `diagnostics`는 마지막 로드 이후의 작업 기록 | 제안 3판(14라운드, 소유자 확인 대기) |
