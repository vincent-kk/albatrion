...
`@canard/schema-form-antd6-plugin` is a plugin for the `@canard/schema-form` library that provides Ant Design v6 UI components for form rendering. This package is part of a larger monorepo (`albatrion`) and specifically extends the schema-form system with pre-built Ant Design v6 components.

**Note**: This is the Ant Design v6 version. For Ant Design v5, use `@canard/schema-form-antd5-plugin` instead.
