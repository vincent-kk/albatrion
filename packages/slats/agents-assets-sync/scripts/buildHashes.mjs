...
//
// Self-executing CLI behavior lives in `./agents-build-hashes.mjs` so this
// file stays free of top-level await and can be bundled into CJS/ESM outputs
// via Rolldown without format errors.
//
// Exported for:
//   - Consumer packages: `import { buildHashes } from '@slats/agents-assets-sync/buildHashes'`
//   - Standalone bin: `./agents-build-hashes.mjs`
//
...
const MANIFEST_FILENAME = 'agents-hashes.json';
