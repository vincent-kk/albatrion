...
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/data-loader --scope=user
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/data-loader --scope=project
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/data-loader --scope=user --dry-run
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/data-loader --scope=user --force
