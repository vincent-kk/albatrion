...
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/json-schema --scope=user
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/json-schema --scope=project
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/json-schema --scope=user --dry-run
npx -p @slats/claude-assets-sync inject-claude-settings --package=@winglet/json-schema --scope=user --force
