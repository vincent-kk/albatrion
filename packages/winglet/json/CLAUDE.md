...
- Reserved member names (`__proto__`, `constructor`, `prototype`) are handled as opaque own data properties (RFC 6901/6902/7396-aligned) — reads never walk the prototype chain, writes never mutate inherited objects
