...
**Version:** 0.10.0 **Description:** Common utility functions for JavaScript/TypeScript projects **License:** MIT **Dependencies:** None (zero runtime dependencies) **ES Target:** ES2020 **Node.js:** 14.0.0+
