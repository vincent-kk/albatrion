 ...
 * console.log(min([NaN, 1])); // NaN (the initial value is retained)
 * console.log(min([1, NaN])); // 1 (a later NaN never compares smaller)
 ...
 * - Unlike `Math.min`, a NaN appearing after the first element does not force NaN
