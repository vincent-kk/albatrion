...
describe('serializeObject', () => {
  ...
  it('should keep every key when one of them is an empty string', () => {
    expect(serializeObject({ a: 1, '': 2, b: 3 })).toBe('b:3|:2|a:1');
  });
});
