...
describe('stringifyObject', () => {
  ...
  it('should stringify the nested object', () => {
    expect(stringifyObject({ a: 1, b: { c: 3 } })).toEqual('a:1|b:{"c":3}');
  });
  it('should stringify the object with undefined', () => {
    expect(stringifyObject({ a: 1, b: undefined })).toEqual('a:1|b:undefined');
  });
  it('should stringify the array', () => {
    expect(stringifyObject([1, 2, 3])).toEqual('0:1|1:2|2:3');
  });
  ...
  it('should stringify the object with array', () => {
    expect(stringifyObject(bigObject)).toEqual(
