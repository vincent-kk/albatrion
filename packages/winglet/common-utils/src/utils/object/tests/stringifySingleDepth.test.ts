...
describe('serializeSingleDepth', () => {
  it('should stringify the object', () => {
    expect(serializeSingleDepth({ a: 1, b: 2 })).toEqual('a:1|b:2');
  });
  it('should stringify the nested object', () => {
    expect(serializeSingleDepth({ a: 1, b: { c: 3 } })).toEqual(
      'a:1|b:{"c":3}',
    );
  });
  it('should stringify the object with undefined', () => {
    expect(serializeSingleDepth({ a: 1, b: undefined })).toEqual(
      'a:1|b:undefined',
    );
  });
  it('should stringify the array', () => {
    expect(serializeSingleDepth([1, 2, 3])).toEqual('0:1|1:2|2:3');
  });
  it('should stringify the object with array', () => {
    expect(
      serializeSingleDepth({
  ...
  it('should stringify the object with array', () => {
    expect(serializeSingleDepth(bigObject)).toEqual(
