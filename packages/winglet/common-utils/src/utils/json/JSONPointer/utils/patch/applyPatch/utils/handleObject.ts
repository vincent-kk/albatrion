// ==================== utils/patchObject.ts 완성 ====================
import { Dictionary } from '@aileron/declare';

import { getValueByPointer } from '@/common-utils/utils/json/JSONPointer/utils/manipulator/getValueByPointer';
import { setValueByPointer } from '@/common-utils/utils/json/JSONPointer/utils/manipulator/setValueByPointer';
