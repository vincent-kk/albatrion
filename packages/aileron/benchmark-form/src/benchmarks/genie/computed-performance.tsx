...
const computedPropertiesSchema = {
  ...
  properties: {
    ...
    dynamicField1: {
      type: 'string',
      'ui:show': '@.trigger === "show"',
      default: 'Visible when trigger is "show"',
    },
    dynamicField2: {
      type: 'number',
      'ui:show': '@.trigger === "number"',
      default: 42,
    },
    dynamicField3: {
      type: 'string',
      'ui:show': '@.trigger === "special" || @.trigger === "show"',
      default: 'Visible for special or show',
    },
  },
};

export async function runGenieComputedPropertiesBenchmark() {
  ...
  try {
    ...
    root.render(
      <GenieForm
        schema={computedPropertiesSchema}
        onValidate={() => {}}
        onChange={() => {
          changeCount++;
        }}
