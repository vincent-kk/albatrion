...
**Purpose**: Ant Design v6 UI plugin for `@canard/schema-form`.
**UI library**: `antd ^6.0.0`
**Component count**: 18
**Peer deps**: `antd >=6.0.0`, `dayjs >=1`, `react >=18 <20`, `react-dom >=18 <20`
...
- API-identical to `@canard/schema-form-antd5-plugin`; only peer dep version differs
