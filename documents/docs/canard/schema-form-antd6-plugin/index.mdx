...
When configured with a JSON Schema, this plugin renders Ant Design 6 form components automatically:
...
:::info Screenshots
Visual demo screenshot will be added at `/img/demos/schema-form-antd6-demo.png`.
:::
