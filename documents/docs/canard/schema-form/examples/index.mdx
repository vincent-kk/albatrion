...
### Getting Started
- [Basic Form](./basic-form) — Common field types: text, number, date, enum, switch
- [Auto-Calculation](./auto-calculation) — Computed derived values with live formula

### Advanced Patterns
- [Conditional Registration](./conditional-registration) — Multi-level if/then/else conditions
- [Dynamic Billing](./dynamic-billing) — Cascading conditions across 3 fields
- [Employment Contract](./employment-contract) — oneOf with const-based field switching
- [Product Catalog](./product-catalog) — Nested oneOf with multi-level branching
- [Media Registration](./media-registration) — Complex oneOf with arrays and nested objects
