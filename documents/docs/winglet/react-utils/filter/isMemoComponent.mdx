---
title: 'isMemoComponent'
sidebar_label: 'isMemoComponent'
---
...
```typescript
const isMemoComponent: <Props extends object = any, Component extends MemoExoticComponent<ComponentType<Props>> = MemoExoticComponent<ComponentType<Props>>>(component: unknown) => component is Component
```
...
|------|------|-------------|
| `component` | `-` | The value to inspect for memoized component characteristics |

## Returns

Type-safe boolean indicating whether the value is a memoized component
...
<WingletPlayground
  ...
  code={`import React, { memo, Component } from 'react';
import { isMemoComponent } from '@winglet/react-utils';
