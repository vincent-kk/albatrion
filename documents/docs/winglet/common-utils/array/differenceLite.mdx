---
title: 'differenceLite'
sidebar_label: 'differenceLite'
---
...
```typescript
const differenceLite: <Type>(source: Type[], exclude: Type[]) => Type[]
```
...
<WingletPlayground
  ...
  code={`import { differenceLite } from '@winglet/common-utils';
