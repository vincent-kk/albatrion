---
title: 'intersectionLite'
sidebar_label: 'intersectionLite'
---
...
```typescript
const intersectionLite: <Type>(source: Type[], target: Type[]) => Type[]
```
...
<WingletPlayground
  ...
  code={`import { intersectionLite } from '@winglet/common-utils';
