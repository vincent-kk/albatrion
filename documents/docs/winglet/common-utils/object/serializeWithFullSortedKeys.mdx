---
title: 'serializeWithFullSortedKeys'
sidebar_label: 'serializeWithFullSortedKeys'
---
...
```typescript
const serializeWithFullSortedKeys: (object: any) => string
```
...
|------|------|-------------|
| `object` | `-` | Object to serialize with full path expansion |

## Returns

Pipe-delimited string of sorted 'fullpath:value' pairs
...
<WingletPlayground
  ...
  code={`import { serializeWithFullSortedKeys } from '@winglet/common-utils';
