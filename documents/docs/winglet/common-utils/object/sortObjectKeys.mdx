---
title: 'sortObjectKeys'
sidebar_label: 'sortObjectKeys'
---
...
```typescript
const sortObjectKeys: <Dict extends Dictionary>(object: Dict | Nullish, keys: string[], options?: {
...
|------|------|-------------|
| `object` | `-` | Source object to reorder (null/undefined returns empty object) |
| `keys` | `-` | Array defining the desired property order |
| `options` | `-` | Optional configuration object |

## Returns

New object with properties ordered according to keys array
...
<WingletPlayground
  ...
  code={`import { sortObjectKeys } from '@winglet/common-utils';
