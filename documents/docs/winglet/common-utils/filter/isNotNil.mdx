...
|------|------|-------------|
| `value` | `-` | Value to test for non-nil (not null and not undefined) |

## Returns

Type-safe boolean indicating whether the value is neither null nor undefined
...
<WingletPlayground
  ...
  code={`import { isNotNil } from '@winglet/common-utils';
