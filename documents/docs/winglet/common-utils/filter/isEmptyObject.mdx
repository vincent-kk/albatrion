...
|------|------|-------------|
| `value` | `-` | Value to test for empty object characteristics |

## Returns

Type-safe boolean indicating whether the value is an empty object
...
<WingletPlayground
  ...
  code={`import { isEmptyObject } from '@winglet/common-utils';
