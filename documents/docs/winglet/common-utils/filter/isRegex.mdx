...
|------|------|-------------|
| `value` | `-` | Value to test for RegExp type |

## Returns

Type-safe boolean indicating whether the value is a RegExp
...
<WingletPlayground
  ...
  code={`import { isRegex } from '@winglet/common-utils';
