...
```typescript
const isCloneable: (object: unknown) => boolean
```
...
|------|------|-------------|
| `object` | `-` | Object or value to test for cloneable characteristics |

## Returns

Boolean indicating whether the object is a cloneable type
...
<WingletPlayground
  ...
  code={`import { isCloneable } from '@winglet/common-utils';
