...
|------|------|-------------|
| `value` | `-` | Value to test for array-like characteristics |

## Returns

Type-safe boolean indicating whether the value is array-like
...
<WingletPlayground
  ...
  code={`import { isArrayLike } from '@winglet/common-utils';
