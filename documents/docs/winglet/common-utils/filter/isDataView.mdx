...
|------|------|-------------|
| `value` | `-` | Value to test for DataView type |

## Returns

Type-safe boolean indicating whether the value is a DataView
...
<WingletPlayground
  ...
  code={`import { isDataView } from '@winglet/common-utils';
