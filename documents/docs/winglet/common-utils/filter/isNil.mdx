...
|------|------|-------------|
| `value` | `-` | Value to test for nil (null or undefined) |

## Returns

Type-safe boolean indicating whether the value is null or undefined
...
<WingletPlayground
  ...
  code={`import { isNil } from '@winglet/common-utils';
