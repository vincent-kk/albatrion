...
|------|------|-------------|
| `value` | `-` | Value to test for emptiness |

## Returns

Boolean indicating whether the value is considered empty
...
// Usage
const form1 = { username: '', email: 'john
```
...
<WingletPlayground
  ...
  code={`import { isEmpty } from '@winglet/common-utils';
