...
|------|------|-------------|
| `value` | `-` | Value to test for primitive type characteristics |

## Returns

Type-safe boolean indicating whether the value is a primitive type
...
<WingletPlayground
  ...
  code={`import { isPrimitiveType } from '@winglet/common-utils';
