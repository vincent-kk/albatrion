...
|------|------|-------------|
| `value` | `-` | Value to test for empty array characteristics |

## Returns

Type-safe boolean indicating whether the value is an empty array
...
<WingletPlayground
  ...
  code={`import { isEmptyArray } from '@winglet/common-utils';
