---
title: 'convertMsFromDuration'
sidebar_label: 'convertMsFromDuration'
---
...
```typescript
const convertMsFromDuration: (duration: string) => number
```
...
|------|------|-------------|
| `duration` | `-` | Duration string to convert (supports ms, s, m, h units) |

## Returns

Equivalent duration in milliseconds, or 0 for invalid input
...
<WingletPlayground
  ...
  code={`import { convertMsFromDuration } from '@winglet/common-utils';
