...
:::info Migrated to `@slats/agents-assets-sync`

This engine was migrated to [`@slats/agents-assets-sync`](../agents-assets-sync/),
which injects one asset tree into Claude Code, Codex, and the vendor-neutral
`.agents` layout. Releases published under this name stay on npm and keep
working, but nothing new ships here — new packages declare `agents.assetPath`
and use the current engine. What follows documents the released
`claude.assetPath` contract.
        ...
        "commands": [
          {
            ...
            "transformed": "@canard-schema-form-my-command.md"
          }
        ],
        "skills": [
          {
            "original": "my-skill.md",
            "transformed": "@canard-schema-form-my-skill.md"
          }
        ]
      }
    }
