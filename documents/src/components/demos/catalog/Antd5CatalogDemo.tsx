...
const sections = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: 'FormTypeInputDateRange',
        trigger: 'format: "date-range"',
        schema: {
          type: 'array',
          title: 'Date Range',
          format: 'date-range',
      ...
      {
        name: 'FormTypeInputTimeRange',
        trigger: 'format: "time-range"',
        schema: {
          type: 'array',
          title: 'Time Range',
          format: 'time-range',
      ...
      {
        name: 'FormTypeInputMonthRange',
        trigger: 'format: "month-range"',
        schema: {
          type: 'array',
          title: 'Month Range',
          format: 'month-range',
